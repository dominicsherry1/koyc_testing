execute as @s[nbt=!{SelectedItem:{tag:{Enchantments:[{id: "minecraft:silk_touch"}]}}}, nbt=!{SelectedItem:{tag:{Enchantments:[{id: "minecraft:fortune"}]}}}] if block ~ ~ ~ #golden_opportunity:shovelable run setblock ~ ~ ~ minecraft:air destroy
execute as @s[nbt={SelectedItem:{tag:{Enchantments:[{id: "minecraft:silk_touch"}]}}}] if block ~ ~ ~ #golden_opportunity:shovelable_no_silk_touch run setblock ~ ~ ~ minecraft:air destroy
execute as @s[nbt={SelectedItem:{tag:{Enchantments:[{id: "minecraft:fortune"}]}}}] if block ~ ~ ~ #golden_opportunity:shovelable_no_fortune run setblock ~ ~ ~ minecraft:air destroy
...
execute if block ~ ~ ~ #golden_opportunity:shovelable run setblock ~ ~ ~ minecraft:air