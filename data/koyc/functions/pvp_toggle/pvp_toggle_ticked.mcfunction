...
execute as @a[tag=enable_pvp,nbt={Dimension:0},tag=!combat_mode] at @s if score @s pvp_overworld matches -1 run execute as @a at @s run playsound koyc:success master @s
...
execute as @a[tag=enable_pvp,nbt={Dimension:-1},tag=!combat_mode] at @s if score @s pvp_nether matches -1 run execute as @a at @s run playsound koyc:success master @s
...
execute as @a[tag=enable_pvp,nbt={Dimension:1},tag=!combat_mode] at @s if score @s pvp_end matches -1 run execute as @a at @s run playsound koyc:success master @s
...
execute as @a[tag=disable_pvp,nbt={Dimension:0},tag=!combat_mode] at @s if score @s pvp_overworld matches 1 run execute as @a at @s run playsound koyc:success master @s ~ ~ ~ 1 0
...
execute as @a[tag=disable_pvp,nbt={Dimension:-1},tag=!combat_mode] at @s if score @s pvp_nether matches 1 run execute as @a at @s run playsound koyc:success master @s ~ ~ ~ 1 0
...
execute as @a[tag=disable_pvp,nbt={Dimension:1},tag=!combat_mode] at @s if score @s pvp_end matches 1 run execute as @a at @s run playsound koyc:success master @s ~ ~ ~ 1 0
