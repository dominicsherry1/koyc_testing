...
execute as @s at @s if score @s tips_timer matches 200..4200 run playsound minecraft:koyc.notification master @s
...
execute as @s at @s if score @s tips_timer matches 4201.. run playsound minecraft:koyc.failure master @s
