...
scoreboard objectives add stone_mined dummy "Stone mined"
...
scoreboard objectives add tnt dummy "TNT used"
scoreboard objectives add player_kills minecraft.custom:minecraft.player_kills "Players murdered"
scoreboard objectives add mob_kills minecraft.custom:minecraft.mob_kills "Mobs brutally slain"
...
scoreboard objectives add sword_swings dummy "Sword swings"
scoreboard objectives add bow_shots minecraft.used:minecraft.bow "Bow shots"
scoreboard objectives add last_death_t minecraft.custom:minecraft.time_since_death
scoreboard objectives add last_death dummy "Days since last died"
scoreboard objectives add last_slept_t minecraft.custom:minecraft.play_one_minute
scoreboard objectives add last_slept dummy "Days since last slept"
scoreboard objectives add times_slept minecraft.custom:minecraft.sleep_in_bed "Times slept in a bed"
scoreboard objectives add items_dropped minecraft.custom:minecraft.drop "Item Drops"
scoreboard objectives add animals_bred minecraft.custom:minecraft.animals_bred "Animals bred"
scoreboard objectives add fish_caught minecraft.custom:minecraft.fish_caught "Fish caught"
scoreboard objectives add villager_talks minecraft.custom:minecraft.talked_to_villager "Times talked to villagers"
scoreboard objectives add villager_trades minecraft.custom:minecraft.traded_with_villager "Villager trades"
...
scoreboard objectives add potions_used dummy "Potions used"
scoreboard objectives add enderpearl minecraft.used:minecraft.ender_pearl "Enderpearls thrown"
scoreboard objectives add enchants minecraft.custom:minecraft.enchant_item "Items enchanted"
scoreboard objectives add nb_tuned minecraft.custom:minecraft.tune_noteblock "Noteblocks tuned"
scoreboard objectives add nb_played minecraft.custom:minecraft.play_noteblock "Noteblocks played"
scoreboard objectives add records minecraft.custom:minecraft.play_record "Records spun"
scoreboard objectives add chests_opened minecraft.custom:minecraft.open_chest "Chests Opened"
scoreboard objectives add shulkers_opened minecraft.custom:minecraft.open_shulker_box "Shulker boxes opened"
scoreboard objectives add sneaked_cm minecraft.custom:minecraft.crouch_one_cm
scoreboard objectives add sneaked_km dummy "Kilometres sneaked"
scoreboard objectives add walked_cm minecraft.custom:minecraft.walk_one_cm
scoreboard objectives add walked_km dummy "Kilometres ambled"
scoreboard objectives add sprinted_cm minecraft.custom:minecraft.sprint_one_cm
scoreboard objectives add sprinted_km dummy "Kilometres sprinted"
scoreboard objectives add swam_cm minecraft.custom:minecraft.swim_one_cm
scoreboard objectives add swam_km dummy "Kilometres swam"
scoreboard objectives add elsa_cm minecraft.custom:minecraft.walk_on_water_one_cm
scoreboard objectives add elsa_km dummy "Kilometres walked on water"
scoreboard objectives add flown_cm minecraft.custom:minecraft.aviate_one_cm
scoreboard objectives add flown_km dummy "Kilometres flown"
scoreboard objectives add horsed_cm minecraft.custom:minecraft.horse_one_cm
scoreboard objectives add horsed_km dummy "Kilometres by horse"
scoreboard objectives add boated_cm minecraft.custom:minecraft.boat_one_cm
scoreboard objectives add boated_km dummy "Kilometres by boat"
scoreboard objectives add railed_cm minecraft.custom:minecraft.minecart_one_cm
scoreboard objectives add railed_km dummy "Kilometres by rail"
scoreboard objectives add pigged_cm minecraft.custom:minecraft.pig_one_cm
scoreboard objectives add pigged_km dummy "Kilometres by pig"
