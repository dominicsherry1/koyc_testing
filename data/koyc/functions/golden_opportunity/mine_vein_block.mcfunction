...
execute as @s[nbt=!{SelectedItem:{tag:{Enchantments:[{id: "minecraft:silk_touch"}]}}}, nbt=!{SelectedItem:{tag:{Enchantments:[{id: "minecraft:fortune"}]}}}] if block ~ ~ ~ #koyc:vein_mining run setblock ~ ~ ~ minecraft:air destroy
...
execute if block ~ ~ ~ #koyc:vein_mining run setblock ~ ~ ~ minecraft:air
execute positioned ~ ~1 ~ if block ~ ~ ~ #koyc:vein_mining if score @s blocks_mined matches ..50 run function koyc:golden_opportunity/mine_vein_block
execute positioned ~ ~-1 ~ if block ~ ~ ~ #koyc:vein_mining if score @s blocks_mined matches ..50 run function koyc:golden_opportunity/mine_vein_block
execute positioned ~-1 ~ ~ if block ~ ~ ~ #koyc:vein_mining if score @s blocks_mined matches ..50 run function koyc:golden_opportunity/mine_vein_block
execute positioned ~1 ~ ~ if block ~ ~ ~ #koyc:vein_mining if score @s blocks_mined matches ..50 run function koyc:golden_opportunity/mine_vein_block
execute positioned ~ ~ ~-1 if block ~ ~ ~ #koyc:vein_mining if score @s blocks_mined matches ..50 run function koyc:golden_opportunity/mine_vein_block
