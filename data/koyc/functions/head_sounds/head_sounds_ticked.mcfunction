...
execute as @a[nbt={Inventory:[{Slot:103b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"WeWereGroot"}}}]}] at @s if score @s jumping_heads matches 1.. run playsound minecraft:koyc.player.weweregroot.ambient player @a
...
execute as @a[nbt={Inventory:[{Slot:103b,id:"minecraft:player_head",tag:{SkullOwner:{Name:"EyeWasGroot"}}}]}] at @s if score @s jumping_heads matches 1.. run playsound minecraft:koyc.player.eyewasgroot.ambient player @a
