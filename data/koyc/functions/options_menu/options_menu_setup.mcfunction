...
scoreboard objectives add option_sneaking minecraft.custom:minecraft.sneak_time "Players sneaking"
scoreboard objectives add option_jumping minecraft.custom:minecraft.jump "Players jumping"